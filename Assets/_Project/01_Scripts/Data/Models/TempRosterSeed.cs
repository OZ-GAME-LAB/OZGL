...
namespace OzGameLab01.Data
{
    ...
    public static class TempRosterSeed
    {
        ...
        public const int STUN_SKILL_ID = 911;
        public const int ATTACK_DOWN_SKILL_ID = 912;
        public const int SILENCE_SKILL_ID = 913;

        // 기존 외부 상수 참조의 호환 별칭
        [System.Obsolete("UNIT_BASIC_ATTACK_SKILL_ID 사용")]
        public const int UnitBasicAttackSkillId = UNIT_BASIC_ATTACK_SKILL_ID;
        [System.Obsolete("DOT_SKILL_ID 사용")]
        public const int DotSkillId = DOT_SKILL_ID;
        [System.Obsolete("STUN_SKILL_ID 사용")]
        public const int StunSkillId = STUN_SKILL_ID;
        [System.Obsolete("ATTACK_DOWN_SKILL_ID 사용")]
        public const int AttackDownSkillId = ATTACK_DOWN_SKILL_ID;
